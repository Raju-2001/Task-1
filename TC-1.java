	   ...
	   // private void fillRegistrationForm() {
	        try {
				...
				WebElement titleDropdown =driver.findElement(
		               By.xpath("//mat-select[@role='combobox']"));
	        	titleDropdown.click();
	        	Thread.sleep(5000);
					...
					country1.click(); 
				     ...
				     Thread.sleep(5000);
						WebElement city1 = driver.findElement(
				            By.xpath("(//span[@class='mdc-list-item__primary-text'])[129]"));
						city1.click();
...
//			            
		            ...
		            WebElement selectCity = driver.findElement(
				            By.xpath("//mat-option[@id='mat-option-645']"));
						selectCity.click();
